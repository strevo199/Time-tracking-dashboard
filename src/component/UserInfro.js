        ...
        <div className=" userinfro lg:h-auto h-56 lg:row-span-2 lg:col-span-1 md:col-span-2 flex flex-col flex-1 rounded-2xl">
            <div className="h-2/3 userinfromain flex justify-center w-full rounded-2xl">
                <div className="w-10/12 flex lg:flex-col lg:justify-evenly gap-6 lg:items-start relative items-center">
                    <img className="lg:w-14 lg:h-14 sm:w-16 sm:h-16 h-10 w-10 border-white border-2 rounded-full" src="../images/image-jeremy.png" alt="" />
                    <div className="">
            ...
            <nav className="flex-1  flex justify-center">
                <ul className="w-10/12 h-full flex lg:flex-col sm:text-lg lg:items-start  text-sm  items-center sm:justify-evenly sm:gap-0 gap-4 justify-center lg:justify-evenly">
                   { nav.map(tab =>(
